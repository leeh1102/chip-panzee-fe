...
const PostDetailComponent = () => {
  ...
  function checkPasscode(passcode) {
    axios.get("http://www.chippinzee.com:2000/api/checkpasscode/" + {id}.id + "?passcode=" + passcode).then(res => {
  ...
  async function getPost() {
    const response = await axios.get("http://www.chippinzee.com:2000/api/" +  {id}.id + "?passcode=" + passcode);
